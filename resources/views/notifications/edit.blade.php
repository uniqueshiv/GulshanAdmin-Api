        ...
        <div class="container">
                ...
                <div class="col-md-8">
                    <div class="panel panel-default" v-cloak>
                        <div class="panel-heading">
                            <div class="clearfix">
                                <span class="panel-title">Edit Notification</span>
          ...
          <section class="wrapper site-min-height">
			...
			<form class="form-horizontal" id="profileForm">
                          ...
                          <input  class="finish btn btn-danger" @click="update" :disabled="isProcessing" value="Finish"/>
                       </form>
                          </div>
                      </section>
                  </div>
...
<!--   <script type="text/javascript" src="{{URL::asset('/assets/assets/bootstrap-daterangepicker/moment.min.js')}}"></script> -->
  ...
  <script src="{{URL::asset('assets/js/jquery.steps.min.js')}}" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        window._form = {!! $notification->toJson() !!};
